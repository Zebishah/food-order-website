import image2 from "../images/top-close-up-view-salad-spices-bell-peppers-with-leaves-board-with-bowl-salad.jpg";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-y-8 justify-center items-center w-[30%] bg-[#ffffff] p-6 rounded-xl">
        ...
        <form className="flex flex-col items-center justify-center w-full gap-y-5">
