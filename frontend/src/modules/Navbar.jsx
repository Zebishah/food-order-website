    ...
    <div className="flex flex-col">
      <div className="w-screen h-[10vh] bg-white shadow-lg flex justify-between items-center px-10 fixed top-0 left-0 right-0 z-10">
        <div className="flex items-center justify-center py-2 pr-6">
          <h1 className="text-3xl text-black font-radios">
            <span className="text-4xl font-extrabold text-green-400 ">R</span>
            ANCHERS
          </h1>
        </div>
        <div className="flex items-center justify-center gap-x-10 ">
          <div className="items-center justify-center hidden lg:flex">
            ...
            <Link
              to={"/"}
              className="px-6 py-2 text-sm lg:text-[16px] text-fade-black font-radios"
            >
              Home
            </Link>
            <Link
          ...
          <div className="flex items-center justify-center gap-x-5">
            <FaCartShopping size={25} className="text-green-400" />
            <div className="flex items-center justify-center gap-x-2">
              <Link to={"/login"}>
                <button className="px-4 py-2 text-sm text-white bg-green-400 rounded-full shadow-lg font-radios">
                  Login
                </button>
              </Link>
              <Link to={"/signUp"}>
          ...
          <ul className="space-y-1.5">
            ...
            <li className="hs-accordion" id="users-accordion">
              ...
              >
                ...
                Dishes
                <svg
                  className="hidden text-gray-600 hs-accordion-active:block ms-auto size-4 group-hover:text-gray-500 dark:text-neutral-400"
                  xmlns="http://www.w3.org/2000/svg"
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
                ...
                <svg
                  className="block text-gray-600 hs-accordion-active:hidden ms-auto size-4 group-hover:text-gray-500 dark:text-neutral-400"
                  xmlns="http://www.w3.org/2000/svg"
                  width={24}
                  height={24}
                  viewBox="0 0 24 24"
              ...
              >
                <ul
                  className="pt-2 hs-accordion-group ps-3"
                  data-hs-accordion-always-open
                >
