const Services = () => {
  return (
    <div id="services" >
      ...
      <div className="font-[sans-serif] w-[80%] mx-auto rounded-xl py-12 px-4">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-16 text-2xl font-bold text-center text-white sm:text-4xl">
            Discover Our Exclusive Features
          </h2>
          <div className="grid gap-12 mx-auto lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg">
            <div className="p-8 text-center transition duration-300 bg-white border-2 border-green-400 shadow-lg cursor-pointer group rounded-xl hover:bg-green-400 hover:text-white hover:shadow-xl">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="inline-block w-16 p-3 mb-4 text-white bg-green-400 rounded-full group-hover:text-white"
                viewBox="0 0 32 32"
              >
                <path
              ...
              <h3 className="mb-3 text-xl font-semibold text-green-400 font-radios group-hover:text-white ">
                Customization
              </h3>
              <p className="text-sm font-radios text-fade-black group-hover:text-white hover:text-white">
                Tailor our product to suit your needs Tailor our product to suit
                your needs.
              </p>
            </div>
            <div className="p-8 text-center text-white transition duration-300 bg-white border-2 border-green-400 shadow-lg cursor-pointer rounded-xl group hover:bg-green-400 hover:text-white hover:shadow-xl">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                className="inline-block w-16 p-3 mb-4 text-white bg-green-400 rounded-full group-hover:text-white"
              ...
              <p className="text-sm font-radios text-fade-black group-hover:text-white">
                Your data is protected by the latest security measures and the
                privacy.
              </p>
            </div>
            <div className="p-8 text-center text-white transition duration-300 bg-white border-2 border-green-400 shadow-lg cursor-pointer rounded-xl group hover:bg-green-400 hover:text-white hover:shadow-xl">
              ...
              <p className="text-sm font-radios group-hover:text-gray-500 text-fade-black group-hover:text-white">
            ...
            <div className="p-8 text-center text-white transition duration-300 bg-white border-2 border-green-400 shadow-lg cursor-pointer rounded-xl group hover:bg-green-400 hover:text-white hover:shadow-xl">
              ...
              <p className="text-sm font-radios group-hover:text-gray-500 text-fade-black group-hover:text-white">
                Experience blazing-fast performance with our product and our
                packages.
              </p>
            </div>
            <div className="p-8 text-center text-white transition duration-300 bg-white border-2 border-green-400 shadow-lg cursor-pointer rounded-xl group hover:bg-green-400 hover:text-white hover:shadow-xl">
