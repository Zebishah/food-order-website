...
const ContactUs = () => {
  return (
    <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]" id="contact">
      ...
      <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
        <div className="bg-[#30ff80] rounded-lg p-6 h-full max-lg:order-1">
          ...
          <ul className="mt-16 space-y-8">
            <li className="flex items-center">
              ...
              <a
                ...
                className="ml-4 text-sm text-white text-gray-500"
              >
                info@example.com
              </a>
            </li>
          ...
          <div className="flex flex-row mt-10 gap-x-4">
            <FaInstagram
              size={50}
              className="p-3 text-green-500 bg-white rounded-full shadow-lg"
            />
            <FaFacebook
              size={50}
              className="p-3 text-green-500 bg-white rounded-full shadow-lg"
        ...
        <div className="p-4 border-2 lg:col-span-2">
          <form>
            <div className="grid gap-8 sm:grid-cols-2">
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full px-2 py-3 text-sm text-black text-gray-800 bg-white border-b border-gray-300 outline-none focus:border-blue-500"
                />
                <svg
                  fill="#bbb"
                  className="w-[18px] h-[18px] absolute right-2"
            ...
            <button
              type="button"
              className="flex items-center justify-center px-4 py-3 mt-12 text-sm tracking-wide text-white bg-green-400 rounded-lg lg:ml-auto max-lg:w-full hover:bg-blue-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
